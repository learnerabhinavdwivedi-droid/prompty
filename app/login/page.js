        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl space-y-6">
          <div className="text-center">
            ...
            <p className="text-sm text-[#888888]">
              Sign in to manage your compression pipelines and API keys.
            </p>
          </div>
          ...
          <form onSubmit={handleCredentialsLogin} className="space-y-4">
            ...
            >
              {loading ? 'Authenticating...' : 'Instant Login as Raj ⚡'}
            </button>
          </form>

          <div className="flex items-center gap-4 my-6">
            <div className="h-px flex-1 bg-white/10" />
            <span className="text-xs text-[#666666] font-medium uppercase tracking-wider">or connect provider</span>
            <div className="h-px flex-1 bg-white/10" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2.5 px-4 py-3 bg-white/5 border border-white/10 text-white rounded-xl font-medium text-xs hover:bg-white/10 transition-colors"
            >
          ...
          <p className="text-xs text-[#666666] text-center mt-6">
            100% Local Authentication Enabled &middot; TokenShrink SaaS
          </p>
        </div>
      </div>
    </div>
