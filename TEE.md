...
We've integrated the `@phala/dstack-sdk` and provided a `Dockerfile` with a `compose.yaml` file so you can easily deploy Prompty onto TEE networks like the [Phala Network Cloud](https://phala.network/) or Automata.
