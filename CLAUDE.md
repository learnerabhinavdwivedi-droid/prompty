# DEVELOPER.md — Prompty

## What This Is

Prompt compression SaaS — reduces LLM token usage without losing meaning. Ships as both a Next.js 16 web app (prompty.com) and a standalone zero-dependency npm SDK (`prompty@2.0.0`).
...
- **Hosting**: Vercel at prompty.com
- **GitHub**: learnerabhinavdwivedi-droid/prompty (SSH protocol)
...
- **Git**: SSH protocol (learnerabhinavdwivedi-droid on GitHub). Deploy by pushing to main — Vercel auto-deploys.
